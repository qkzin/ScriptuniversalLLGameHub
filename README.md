...
gameNameLabel.Size = UDim2.new(1,-20,0,35)
gameNameLabel.Position = UDim2.new(0,10,0,10)
gameNameLabel.BackgroundTransparency = 1
gameNameLabel.Text = "Jogo: Carregando..."
...
posXLabel = Instance.new("TextLabel")
posXLabel.Size = UDim2.new(1,-20,0,25)
posXLabel.Position = UDim2.new(0,10,0,95)
posXLabel.BackgroundTransparency = 1
posXLabel.Text = "X: 0.00"
posXLabel.TextColor3 = Color3.fromRGB(200,220,255)
posXLabel.Font = Enum.Font.GothamBold
posXLabel.TextSize = 16
posXLabel.Parent = infoContainer

posYLabel = posXLabel:Clone()
posYLabel.Position = UDim2.new(0,10,0,125)
posYLabel.Text = "Y: 0.00"
posYLabel.Parent = infoContainer

posZLabel = posXLabel:Clone()
posZLabel.Position = UDim2.new(0,10,0,155)
posZLabel.Text = "Z: 0.00"
posZLabel.Parent = infoContainer
